# Run the program "python parse_celex_to_IPA_g2p.py celex_g2p.dict"
...
def strip_line(line, dict_IPA):
	...
	if not (" " in new_line_split_list[1]):
		...
		final_string = ' '.join(IPA_list)
		new_line = new_line_split_list[1].lower() + " , " + final_string + "\n"
	return new_line
...
def parse_file():
	...
	new_filename="CELEX_IPA_data_g2p.txt"
